...
export default function ProfilesManagement() {
    ...
    const loadProfiles = async () => {
        try {
            setLoading(true);
            const res = await api.get("/profiles-privileges/profiles");
    ...
    const handleCreateProfile = async () => {
        ...
        try {
            await api.post("/profiles-privileges/profiles", newProfile);
    ...
    const handleUpdateProfile = async () => {
        ...
        try {
            await api.patch(`/profiles-privileges/profiles/${editProfile.id}`, {
